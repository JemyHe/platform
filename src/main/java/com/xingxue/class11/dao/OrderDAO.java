...
public class OrderDAO extends BaseMyBatisDAO {
    ...
    private static final String ORDER_MAPPER_NAMESPACE = "com.xingxue.class11.entity.mapper.OrderMapper";

    private static final String ORDERDETAIL_MAPPER_NAMESPACE = "com.xingxue.class11.entity.mapper.OrderDetailMapper";
